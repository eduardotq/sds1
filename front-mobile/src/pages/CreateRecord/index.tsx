...
import {Text, StyleSheet, View, TextInput, Keyboard, Alert} from 'react-native'
...
const CreateRecord = () => {
  ...
  const handleChangedPlatform = (selectedPlatform: GamePlatform) =>{
    setPlatform(selectedPlatform);
    const gamesByPlatform = allGames.filter(
      game => game.plaftorm ===selectedPlatform
    )
  ...
  axios.get(`${BASE_URL}/games`).then(response=>{
    ...
    return (
        ...
        <View style={styles.container}>
          ...
          icon='laptop'
          onChange={handleChangedPlatform}
